...
export default function EventosRecentes() {
  ...
  return (
    <div
      className="w-1/2 dashbo bg-gradient-to-b from-[#1C1C1C] to-[#424242] dark:bg-gray-900 text-white dark:text-white p-6 rounded-2xl h-120 shadow-[1px_1px_15px_2px_black] "
      data-aos="fade-up"
    >
