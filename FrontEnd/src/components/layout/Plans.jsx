const Finish = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/planosImage/Finish+Flag.png";
const TechSyner = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/planosImage/Rocket.png";
const Infinite = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/planosImage/Infinity+Symbol.png";
const selectBlue = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/planosImage/gg_check-o.png";
const selectSyn = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/planosImage/gg_check-o+(1).png";
const selectGray = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/planosImage/gg_check-o+(2).png";
  ...
  return (
    <div className="px-6 py-16 text-center flex flex-col gap-7">
      <div className="text_Content">
        ...
        <p className="text-gray-600 m-auto w-[100%] md:w-[40%]">
        ...
        <div className="border border-black/20 rounded-xl p-6 shadow-sm bg-white flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-xl font-semibold text-[#2c2c2c]">Starter</h2>
            </div>
            <p className="text-sm !text-gray-500 mb-4 text-left">
              Busque e participe de eventos, receba materiais e ganhe 10 Byns no
              primeiro evento.
            </p>
            <p className="text-2xl font-bold text-left !text-[#2c2c2c]">
              $0{" "}
        ...
        <div className="border-2 border-blue-500 rounded-xl p-6 shadow-sm bg-white flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-xl font-semibold text-[#2c2c2c]">Infinite</h2>
            </div>
            <p className="text-sm !text-gray-500 mb-4 text-left">
