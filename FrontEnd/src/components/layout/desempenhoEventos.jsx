...
const Public = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Dashboard/Group.png"; // Ícone para "Público Geral".
const Confirmed = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Dashboard/Event+Accepted.png"; // Ícone para "Confirmados".
const Canceled = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Dashboard/Event+Declined.png"; // Ícone para "Cancelados".
...
export default function DesempenhoEventos() {
  ...
  return (
    ...
    <div
      ...
      className="dashbo bg-gradient-to-b from-[#1C1C1C] to-[#424242] text-white p-6 rounded-2xl shadow-[1px_1px_15px_2px_black] w-100 h-120"
    >
