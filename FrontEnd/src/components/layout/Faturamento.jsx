...
function Card({ title, value, percentage, isPositive, chartColor }) {
  return (
    ...
    <div className="dashbo bg-gradient-to-b from-[#1C1C1C] to-[#424242] dark:bg-gray-900 text-white dark:text-white p-4 rounded-2xl shadow-[1px_1px_15px_2px_black] h-[200px] w-100 ">
