...
const User =
  "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Notifications/User.png";
const Materials =
  "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Notifications/Microsoft.png";
const Configs =
  "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Notifications/Settings.png";
const Help =
  "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Notifications/Help.png";
const Woman =
  "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/UsuarioPagina/woman.png";
        ...
        <div className="flex flex-col items-center">
          <div className="top_Content flex gap-10 items-center">
            ...
            <div className="top_middle_infos_account transform translate-x-[-20px]">
              <h2 className="text-lg font-bold text-[#212121]">Ana Santos</h2>
          ...
          <div className="w-full text-sm flex gap-2.5 flex-col mt-2">
            ...
            <Link
              to="/private/User"
              className="flex items-center gap-2 py-2 w-full text-left !text-[#212121] hover:bg-gray-100 px-2 rounded"
            >
            ...
            <div className="flex justify-between items-center px-2 text-sm">
              <div>
                <p className="font-semibold !text-[#212121]">Plano Grátis</p>
