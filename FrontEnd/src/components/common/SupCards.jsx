...
const Cards = ({ h1, pr, imgs }) => {
  return (
    ...
    <div
      className="flex flex-col bg-gradient-to-r from-[#FFFFFF] to-[#ffffff] items-center justify-center bg-beige h-[220px] md:h-[280px] w-[350px] md:w-[550px] gap-[3px] text-center cursor-pointer rounded-[2px]"
