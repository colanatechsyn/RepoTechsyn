...
function Card({
  ...
  return (
    ...
    <div className="card flex flex-col lg:gap-0 2xl:gap-4 gap-4 2xl:hover:scale-107 lg:hover:scale-107 transition-all ease-initial">
      {/* Seção do cabeçalho do card, exibindo as informações da empresa organizadora do evento. */}
      <div className="header_card  lg:scale-89 2xl:scale-100  flex justify-start gap-3 items-center">
      ...
      <div className="w-[300px] transform translate-y-[0px] 2xl:translate-y-[0px] lg:translate-y-[-15px] lg:scale-86 2xl:scale-94 rounded-2xl shadow-lg overflow-hidden bg-white">
        ...
        <div className="p-4">
          ...
          {/* Título do evento. */}
          <h2 className="pl-2 text-xl font-bold text-[#2c2c2c]">{title}</h2>
