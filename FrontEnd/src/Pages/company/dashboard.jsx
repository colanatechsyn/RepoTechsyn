...
const back = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/Dashboard/Back.png";
    ...
    <>
      ...
      <div className="flex flex-row h-[450px] bg-gradient-to-t from-[#982FDC] to-[#2843B3] items-center justify-between px-[6%]">
        ...
        <img
          src={back}
          alt=""
          className="dashback h-[450px] left-[-11%] tranform translate-y-30 rotate-15 absolute z-0 invert"
          data-aos="fade-right"
          data-aos-delay="200"
