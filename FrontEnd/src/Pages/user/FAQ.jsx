...
const faqBackground = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/FAQimages/Rectangle+90.png";
...
const FAQ = () => {
  ...
  return (
    <div className="relative z-10 overflow-hidden transform translate-y-[-50px] md:translate-y-[-0px] ">
      {/* Imagem de fundo posicionada atrás de tudo */}
      <img
        src={faqBackground}
        alt="FAQ Background"
        className="absolute w-full h-full z-[-1] top-19 bg-fixed transition-all 500ms hidden md:flex"
      />
      ...
      <div
        className="w-full max-w-3xl mx-auto px-4 mt-10 z-20 mb-20"
        data-aos="fade-up"
        data-aos-delay="200"
        data-aos-duration="1000"
      >
