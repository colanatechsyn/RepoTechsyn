...
const BackgroundVideo = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/videos/2646392-hd_1920_1080_30fps.mp4";

const Arrow = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/HomeIamges/left-arrow.svg";
const MaxineImg = "https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/MaxineImages/Maxine.png";
function Home() {
  return (
    <section className="Main flex flex-col w-full items-center gap-30">
      ...
      <section className="homeback relative bg-gradient-to-b via-indigo-500 from-purple-500 to-white text-white min-h-screen flex items-center justify-center px-6 py-10 w-full">
        {/* Ajustado para flex-col em mobile, padding vertical em mobile, e transform apenas para desktop */}
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-53 items-center transform md:translate-y-[-60px] py-8 md:py-0">
          {/* Left Text Section */}
          {/* Largura total em mobile, texto centralizado em mobile, e largura original para desktop */}
          <div className="w-full text-center md:text-left md:w-[1000px]">
            <h2 className="text-sm bg-purple-100 bg-clip-text text-transparent mb-2">
              CONSTRUA SEU FUTURO NA TECNOLOGIA!
            </h2>

            {/* Font size ajustado para mobile, mantendo o desktop */}
            ...
            {/* Largura máxima e margin-top para mobile */}
            <p className="text-sm text-white-600 mt-6 max-w-md mx-auto md:mx-0">
          ...
          {/* Right Image Section */}
          {/* Ajustado para display flex apenas em md e acima, e largura total em mobile.
        Removido transform para mobile. */}
          <div className="flex justify-center relative w-full md:w-140 mt-8 md:mt-0">
            {/* Placeholder for 2 mobile mockups */}
            <img
              src={MaxineImg}
              className="rotate-y-180 transform md:translate-y-" // Mantém o translate-y para desktop, remove para mobile
            />
          </div>
        </div>
        {/* Seta "Ver Mais": escondida em mobile, visível em md e acima. */}
        <div className="verMais w-11 h-11 bottom-37 absolute rounded-full animate-bounce shadow-md hidden md:flex justify-center items-center">
          <img src={Arrow} className="rotate-270 filter invert" />
        </div>
      </section>
      <div
        className="top_middle_banner w-[90%] flex justify-center mt-0 md:mt-8 mb-0 md:mb-[-100px]" // Adicionado mt-8 para mobile
        data-aos="fade-right"
        data-aos-delay="200"
      ...
      >
        <Card
          ...
          enterpriseLogo="/src/asset/imgs/inova-logo.png"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/5f8159_2e08f10003074706bb1de62d55d0aebc~mv2.avif"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/AWE-Asia-Immersive-technology-event.jpg"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/5f8159_1a9a477d609742d09de9f3abe1750f41~mv2.avif"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/tecnologia-para-eventos.jpg"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/projetor-para-eventos-em-sao-paulo-1.jpg"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/unnamed.png"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/eventos_de_tecnologia_e_negocios-1-994x495.jpeg"
      ...
      >
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/15_de_mai._de_2025_22_18_41.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_a_photorealistic_image_of_a_cuttingedge_techno_3.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_a_vibrant_image_that_captures_the_essence_of_i_1.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_an_image_that_evokes_a_sense_of_technology_and_2.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/267096-top-x-principais-eventos-de-marketing-digital-para-2019.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_highly_detailed_and_realistic_images_depicting_0.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/corporate-businessman-giving-presentation-large-audience.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_A_vibrant_and_bustling_scene_depicting_a_reallife_tec_2.webp"
      ...
      >
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_an_image_that_evokes_a_sense_of_pioneering_inn_1.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_create_an_image_of_a_cuttingedge_technology_event_sho_0.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_an_image_depicting_a_bustling_technology_event_3.webp"
        ...
        <Card
          ...
          eventImage="https://assetstechsyn01.s3.sa-east-1.amazonaws.com/assets/imgs/EventsImage/Flux_Dev_Create_an_image_of_a_bustling_technology_event_where__3.webp"
